...
/* Search */
$('#search input[name=\'search\']').parent().find('.btn-default').on('click', function() {

var url = $('base').attr('href') + 'index.php?route=product/search&wildcard=true';
...
if (e.keyCode == 13) {
$('#search input[name=\'search\']').parent().find('.btn-default').trigger('click');
}
});
...
if (json['success']) {
$('#content').parent().before('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>' + json['success'] + '</div>');
setTimeout(function(){
                $('.alert').fadeOut() }, 1500);
}
...
$('#additional-menu li.user').hover(function() {
...
// jasny bootstrap for mobile menu
$(document).ready(function() {
    if ("undefined" == typeof jQuery) throw new Error("Jasny Bootstrap's JavaScript requires jQuery"); + function(a) {
        ...
        b.DEFAULTS = {
            ...
            if (!a.support.transition) {
                var e = {};
                return e[this.placement] = "+=" + c, b.animate(e, 300, d)
            }
            ...
            }), this.$element.one(a.support.transition.end, d).emulateTransitionEnd(30)
            ...
            if (!this.state) {
                ...
                if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                    ...
                    var c = this.getCanvasElements(),
                        ...
                        void 0 === a(this).data("offcanvas-style") && a(this).data("offcanvas-style", a(this).attr("style") || ""), "auto" !== a(this).css(d) && "0px" !== a(this).css(d) || "auto" !== a(this).css(e) && "0px" !== a(this).css(e) || a(this).css(d, 0)
...
$(document).ready(function addLink() {
...
//Здесь находится содержание добавляемого линка
	var pagelink = "<p> Подробнее на сайте Весы Универсал: <a href='"+document.location.href+"'>"+document.location.href+"</a></p>";
	//Количество разрешенных символов,  100
if (sel_count > 99){
