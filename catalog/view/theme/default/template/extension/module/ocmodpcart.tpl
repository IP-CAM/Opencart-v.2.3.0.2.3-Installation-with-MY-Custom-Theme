...
<?php if ($products) { ?>
  ...
  <div class="ocmod-popup-center">
      ...
      <tbody>
        ...
        <tr>
          <td class="image">
            ...
            <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" width="150" height="150" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
            <?php } ?>
          </td>
          <td class="name">
          ...
          <td class="qt">
            <div class="number">
              ...
              <div class="frame-change-count">
                <div class="btn-plus">
                  <button type="button" class="btn-primary" onclick="$(this).parent().parent().next().val(~~$(this).parent().parent().next().val()+1); update( this, 'update' );">
                    +
                  </button>
                </div>
                <div class="btn-minus">
		  ...
		  <td class="remove">
            <button type="button" onclick="update( this, 'remove' );"><i class="far fa-trash-alt"></i></button>
    ...
    <?php foreach ($products as $product) { ?>
      <div>
        <div class="image">
          <?php if ($product['thumb']) { ?>
          <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" width="150" height="150" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
          <?php } ?>
        </div>
        <div class="name">
          <a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
  ...
  <div class="ocmod-popup-footer">
    ...
    <div class="clear-total">
        	<button type="button" id="check" class="btn btn-inverse" onclick="location='<?php echo $checkout_link; ?>'"><p><?php echo $total['title']; ?> <strong><?php echo $total['text']; ?></strong><p/><strong><i class="fa fa-share"></i> <?php echo $button_checkout; ?></strong></button>
        </div>
      <?php } ?> </div>
<?php } else { ?>
  ...
  <div class="ocmod-popup-footer">
    <button type="button" class="btn btn-default" onclick="$.magnificPopup.close();"><strong><?php echo $button_shopping; ?></strong></button>
  </div>
<?php } ?>
</div>
 </div>
