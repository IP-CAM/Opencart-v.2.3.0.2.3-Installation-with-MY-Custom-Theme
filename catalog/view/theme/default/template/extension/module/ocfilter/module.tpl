...
<div class="ocf-offcanvas ocfilter-mobile">
  <div class="ocfilter-mobile-handle">
    <button type="button" class="btn btn-primary" id="ocfiltercancas" data-toggle="offcanvas"><div><?php echo $heading_title; ?></div> <i class="fa fa-filter"></i></button>
  </div>
...
$(function() {
  ...
  $('#ocfiltercancas').on('click', function(e) {
