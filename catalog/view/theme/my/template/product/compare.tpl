 ...
 <div class="fb-like" data-href="https://www.facebook.com/stroymarketplus" data-lazy="true" data-width="" data-layout="standard" data-action="like" data-size="small" data-share="false"></div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><?php if ($product['thumb']) { ?>
              <img src="<?php echo $product['thumb']; ?>" width="248" height="248" alt="<?php echo $product['name']; ?>" class="img-thumbnail" />
              <?php } ?></td>
            <?php } ?>
          </tr>
          <tr>
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php if ($product['cart'] == true) { ?>
<?php echo $button_incart; ?>
<?php } else { ?>
<?php echo $button_cart; ?>
<?php } ?>" class="btn btn-primary btn-block cartadd" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
            <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-danger btn-block"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
    </div>
