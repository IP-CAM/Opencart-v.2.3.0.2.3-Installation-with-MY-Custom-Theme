...
<li>
 <span><strong><?php echo $attribute['name']; ?>:</strong></span> 
...
<?php } ?>
 <span class="attribute"><strong><?php echo $product['name']; ?></strong></span>
</div>
          </div>
    </div>
  </div>
