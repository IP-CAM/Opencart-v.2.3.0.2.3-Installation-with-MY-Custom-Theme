...
foreach ($this->cart->getProducts() as $product) {
    if ($product['product_id'] == $product_info['product_id']) {
        ...
        break;
			...
			$data['text_torg'] = $this->language->get('text_torg');
			$data['text_paypartstitle'] = $this->language->get('text_paypartstitle');
			$data['text_rassrochtitle'] = $this->language->get('text_rassrochtitle');
 ...
 //manufac
        ...
        foreach ($this->cart->getProducts() as $product) {
			...
			$data['column_leftt'] = $this->load->controller('common/column_leftt');
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['column_right'] = $this->load->controller('common/column_right');
			$data['column_rightt'] = $this->load->controller('common/column_rightt');
	...
	public function write() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if ((utf8_strlen($this->request->post['text']) < 0) || (utf8_strlen($this->request->post['text']) > 200)) {
