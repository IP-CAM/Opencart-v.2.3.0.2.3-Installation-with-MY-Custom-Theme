...
class ControllerExtensionPaymentPrivat24 extends Controller {
	...
	public function index() {
		...
		$data['button_continue_action'] = $this->url->link('extension/payment/privat24/checkout', '', 'SSL');
	...
	public function checkout() {
		...
		$server_url = $this->url->link('extension/payment/privat24/callback', '', 'SSL');
		$return_url = $this->url->link('extension/payment/privat24/returnUrl', '', 'SSL');
