	...
	public function add() {
     ...
     $this->load->model('tool/image');				
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id']), $image, $product_info['name'], $this->url->link('checkout/checkout').'#cart_view', $this->url->link('checkout/checkout'));
