...
$_['text_checkout_customer_login']   = 'Вход в кабинет';
...
$_['text_empty']                     = '<h2>Ваша корзина пуста. Используйте поиск, или выбирайте в каталоге нужные принадлежности. Приятных покупок :)</h2>';
$_['text_login']                     = 'Необходимо войти в <a href="%s">личный кабинет</a> или создать <a href="%s">учетную запись</a> чтобы видеть цены!';
$_['text_agree']                     = 'Согласие с документом <a class="colorbox fancybox agree" href="%s" alt="%s"><b>%s</b></a>';
$_['text_agree_shoppica']            = 'Согласие с документом <a class="s_main_color" rel="prettyPhoto[ajax]" href="%s&iframe=true" alt="%s"><b>%s</b></a>';
...
$_['error_no_payment']               = 'Оплата по данному адресу невозможна! Обратитесь к <a href="%s">Администрации</a>!';
$_['error_min_amount']               = 'Простите, минимальная сумма для заказа %s. Пожалуйста, выберете что-то еще.';
...
$_['text_delivery'] 									= '<p class="tags">Доставку оплачивает покупатель согласно тарифам перевозчика. При заказе от 2000 грн доставка бесплатная (не распространяется на крупногабаритные товары). Если вы сделаете предоплату, то получите скидку на услуги почтовой службы. Приятных покупок!</p>';
$_['text_cleancart'] 									= 'Очистить корзину';
$_['text_youshore'] 									= 'Вы уверены?';
?>