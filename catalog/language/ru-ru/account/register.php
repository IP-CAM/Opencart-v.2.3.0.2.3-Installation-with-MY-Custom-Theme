...
$_['text_account_already'] = 'Если вы уже зарегистрированы, перейдите на страницу <a href="%s">входа</a>.';
...
$_['text_agree']           = 'Согласие с документом <a href="%s" class="agree"> <b> %s</b></a>';
...
$_['entry_telephone']      = 'Телефон в формате 380*********';
$_['entry_fax']            = 'Факс';
$_['entry_company']        = 'Компания';
$_['entry_address_1']      = 'Отделение почты';
$_['entry_address_2']      = 'Адрес (дополнительно)';
$_['entry_postcode']       = '№ отделения';
$_['entry_city']           = 'Город';
...
$_['error_telephone']      = 'Телефон должен быть в формате 380 и состоять из 12 цифр';
...
$_['error_postcode']       = 'В № отделения должно быть от 1 до 10 символов';
