...
$_['text_agree']           = 'Погодження з документом <a href="%s" class="agree"> <b>%s </b> </a>';
...
$_['entry_telephone']      = 'Телефон у форматі 380*********';
$_['entry_fax']            = 'Факс';
...
$_['error_telephone']      = 'Телефон повинен бути в форматі 380 і складатися з 12 символів';
