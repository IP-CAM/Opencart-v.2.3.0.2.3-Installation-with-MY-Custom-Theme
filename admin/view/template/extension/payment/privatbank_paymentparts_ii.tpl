          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($privatbank_paymentparts_ii_hold) { ?>
                    <input type="radio" name="privatbank_paymentparts_ii_hold" value="1" checked="checked" />
                    <?php echo $entry_payment_type_hold; ?>
                    <?php } else { ?>
                    <input type="radio" name="privatbank_paymentparts_ii_hold" value="1" />
                    <?php echo $entry_payment_type_hold; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$privatbank_paymentparts_ii_hold) { ?>
                    <input type="radio" name="privatbank_paymentparts_ii_hold" value="0" checked="checked" />
                    <?php echo $entry_payment_type_standart; ?>
                    <?php } else { ?>
                    <input type="radio" name="privatbank_paymentparts_ii_hold" value="0" />
                    <?php echo $entry_payment_type_standart; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group required">                
                ...
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_ii_paymentquantity" value="<?php echo $privatbank_paymentparts_ii_paymentquantity; ?>" placeholder="<?php echo $entry_paymentquantity; ?>" id="input-ii-paymentquantity" class="form-control"/>
              ...
              <div class="form-group">                
                <label class="col-sm-2 control-label" for="input-privatbank_paymentparts_ii_min_total"><span data-toggle="tooltip" title="<?php echo $help_min_total; ?>"><?php echo $entry_min_total; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_ii_min_total" value="<?php echo $privatbank_paymentparts_ii_min_total; ?>" placeholder="<?php echo $entry_min_total; ?>" id="input-privatbank_paymentparts_ii_min_total" class="form-control"/>
                </div>
              </div>          
              <div class="form-group">                
                <label class="col-sm-2 control-label" for="input-privatbank_paymentparts_ii_max_total"><span data-toggle="tooltip" title="<?php echo $help_max_total; ?>"><?php echo $entry_max_total; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_ii_max_total" value="<?php echo $privatbank_paymentparts_ii_max_total; ?>" placeholder="<?php echo $entry_max_total; ?>" id="input-privatbank_paymentparts_ii_max_total" class="form-control"/>
                </div>
              </div>
              <div class="form-group">                
                <label class="col-sm-2 control-label" for="input-privatbank_paymentparts_ii_markup"><span data-toggle="tooltip" title="<?php echo $help_markup; ?>"><?php echo $entry_markup; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_ii_markup" value="<?php echo $privatbank_paymentparts_ii_markup; ?>" placeholder="<?php echo $entry_markup; ?>" id="input-privatbank_paymentparts_ii_markup" class="form-control"/>
                </div>
              </div>  
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
                <div class="col-sm-10">
                  <select name="privatbank_paymentparts_ii_geo_zone_id" id="input-geo-zone" class="form-control">
                    <option value="0"><?php echo $text_all_zones; ?></option>
                    <?php foreach ($geo_zones as $geo_zone) { ?>
                    <?php if ($geo_zone['geo_zone_id'] == $privatbank_paymentparts_ii_geo_zone_id) { ?>
              ...
              <div class="form-group">                  
                ...
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_ii_sort_order" value="<?php echo $privatbank_paymentparts_ii_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort_order" class="form-control"/>
                </div>
              </div>	
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($privatbank_paymentparts_ii_enabled) { ?>
                    <input type="radio" id="enabled_all" name="privatbank_paymentparts_ii_enabled" value="1" checked="checked" />
                    <?php echo $entry_enabled_productcard; ?>
                    <?php } else { ?>
                    <input type="radio" id="enabled_all" name="privatbank_paymentparts_ii_enabled" value="1" />
                    <?php echo $entry_enabled_productcard; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$privatbank_paymentparts_ii_enabled) { ?>
                    <input type="radio" id="enabled_selected" name="privatbank_paymentparts_ii_enabled" value="0" checked="checked" />
                    <?php echo $entry_enabled_all; ?>
                    <?php } else { ?>
                    <input type="radio" id="enabled_selected" name="privatbank_paymentparts_ii_enabled" value="0" <?php echo $privatbank_paymentparts_ii_products_allowed?'disabled':''; ?>/>
                    <?php echo $entry_enabled_all; ?>
                    <?php } ?>
                  </div>
              </div>
			  <div class="form-group">
				...
				<div class="col-sm-10">
					...
					<?php foreach ($privatbank_paymentparts_ii_products_allowed as $product_allowed) { ?>
					<div id="product-allowed<?php echo $product_allowed['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_allowed['name']; ?>
					<input type="hidden" name="privatbank_paymentparts_ii_product_allowed[]" value="<?php echo $product_allowed['product_id']; ?>" />
					</div> 
					<?php } ?>
				  </div>
				</div>
      ...
      $.ajax({
        ...
        success: function(data) {          
          $.each(data, function(index, item) {
            ...
            $('#product-allowed').append('<div id="product-allowed' + item.product_id + '"><i class="fa fa-minus-circle"></i> ' + item.name + '<input type="hidden" name="privatbank_paymentparts_ii_product_allowed[]" value="' + item.product_id + '" /></div>');
...
$('input[name=\'allowed\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-allowed').append('<div id="product-allowed' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="privatbank_paymentparts_ii_product_allowed[]" value="' + item['value'] + '" /></div>');
