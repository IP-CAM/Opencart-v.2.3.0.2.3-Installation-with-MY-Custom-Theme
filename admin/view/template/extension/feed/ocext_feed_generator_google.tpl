...
<div id="content">
    ...
    <div class="panel-body">
        ...
        <div id="tab-ym-categories" class="tab-pane" >
            <div align="right">
                <button onclick="$('#form-ym-categories').submit();" type="submit" form="form-ups" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>  <?php echo $button_save; ?></button>
                <br><br>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <button onclick="$('#form-ym-categories-filter').submit();" title="<?php echo $button_filter; ?>" class="btn btn-primary pull-right"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
              </div>
            </div>
          </div>
        </form>
                        ...
                        <tr>
                          ...
                          <td class="text-left">
                              <input placeholder="Find a category" class="form-control" onkeyup="getCategories(<?php echo $ym_category['ym_category_id'] ?>,this.value)" />
                                ...
                                <span style="margin-top: 5px; display: none;" id="ym_categories_save_<?php echo $ym_category['ym_category_id'] ?>" onclick="$('#form-ym-categories').submit();" type="submit" form="form-ups" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>  <?php echo $button_save; ?></span>
        ...
        <div id="tab-ym-filter-data" class="tab-pane" >
            <form id="form-ym-filter-data" action="<?php echo $action_ym_filter_data; ?>" method="post" enctype="multipart/form-data">
                <div align="right" class="filter_data_box">
                    <button onclick="$('#form-ym-filter-data').submit();" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>  <?php echo $button_save; ?></button>
                    <br><br>
                </div>
                <div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <select onclick="openYmFilterData(this.value); $('input[name=ocext_feed_generator_google_ym_filter_data_filter_data_name]').val($('select[name=ocext_feed_generator_google_ym_filter_data_filter_data_group_id] option:selected').text()) " class="form-control" name="ocext_feed_generator_google_ym_filter_data_filter_data_group_id">
        ...
        <div id="tab-template-setting" class="tab-pane active" >
            ...
            <div align="right">
                <button onclick="$('#form-template-setting').submit();" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>  <?php echo $button_save; ?></button>
            <br><br>
            </div>
            ...
            <div id="tab-general-setting" class="tab-pane" >
                <div align="right">
                    <button onclick="$('#form-general-setting').submit();" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>  <?php echo $button_save; ?></button>
                    <br><br>
                </div>
