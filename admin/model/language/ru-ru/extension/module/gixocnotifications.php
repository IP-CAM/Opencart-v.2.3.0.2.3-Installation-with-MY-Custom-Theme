...
$_['text_lite_version']             = ' - версия без инструкций по настройке и прокси';
...
$_['help_new_order_ex']             = 'Новый заказ №{order_id}, магазин {store_name}, номер телефона: {customer_telephone}, e-mail: {customer_email}, {product_name}';
...
$_['help_new_customer_ex']          = 'Зарегистрировался новый покупатель: {customer_firstname}, номер телефона: {customer_telephone}, e-mail: {customer_email}';
...
$_['help_new_review_ex']            = 'Отзыв к товару {product_name} (артикул {product_sku}) от покупателя {name}, магазин {store_name}. Текст отзыва: {review}';
