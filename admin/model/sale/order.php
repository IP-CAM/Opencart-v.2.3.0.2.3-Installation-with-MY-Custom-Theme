...
public function getOrderProductManufacturers($order_id, $order_product_id, $product_id) {
				$query = $this->db->query("SELECT *, p.product_id AS product_id, op.product_id AS order_product_product_id, m.manufacturer_id AS manufacturer_id, p.manufacturer_id AS product_manufacturer_id, m.name AS manufacturer_name FROM " . DB_PREFIX . "order_product op LEFT JOIN " . DB_PREFIX . "product p ON (p.product_id = op.product_id) LEFT JOIN " . DB_PREFIX . "manufacturer m ON (m.manufacturer_id = p.manufacturer_id) WHERE order_id = '" . (int)$order_id . "' AND op.order_product_id = '" . (int)$order_product_id . "' AND op.product_id = '" . (int)$product_id . "'");
