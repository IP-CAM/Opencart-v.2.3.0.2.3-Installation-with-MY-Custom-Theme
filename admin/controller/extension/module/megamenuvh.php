...
class ControllerExtensionModuleMegamenuvh extends Controller
{
	...
	public $aleksey_6 = 'http://stroymarketplus.com';
	...
	public function autocategoryadd()
	{
		...
		if (isset($this->request->get['autocategoryadd']) && ($this->request->get['autocategoryadd'] != '') && $this->validatePopup()) {
			...
			foreach ($category_auto as $category) {
				...
				$category_setting = array('variant_category' => 'simple', 'show_sub_category' => '1', 'category_img_width' => '100', 'category_img_height' => '100', 'category_list' => $children_data);
