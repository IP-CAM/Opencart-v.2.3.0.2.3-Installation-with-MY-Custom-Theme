...
class ControllerExtensionTotalPrivat24Fee extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/total/privat24_fee', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		
		$data['action'] = $this->url->link('extension/total/privat24_fee', 'token=' . $this->session->data['token'], 'SSL');
