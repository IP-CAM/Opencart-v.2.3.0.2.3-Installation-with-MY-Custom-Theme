...
For only - <b style="color: #1E91CF">[<a href="http://feofan.net" target="_blank">feofan.net</a>]</b>';
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/privat24', 'token=' . $this->session->data['token'], 'SSL')
		);
		$data['action'] = $this->url->link('extension/payment/privat24', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['privat24_server_url'] = HTTP_CATALOG . 'index.php?route=extension/payment/privat24/callback';
		$data['privat24_return_url'] = HTTP_CATALOG . 'index.php?route=extension/payment/privat24/success';
